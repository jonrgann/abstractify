              ...
              <div className="grid grid-cols-[auto_auto_1fr_auto_auto] gap-4">
                <Field className='w-[100px]'>
                  ...
                  <InputGroup data-disabled>
                    <InputGroupInput id="lot" placeholder={ status === 'active' ? '' : 'None'} disabled value={query.lot ?? ''} />
                    {(status === 'active' && !query.lot) && (
                      <InputGroupAddon>
                ...
                <Field className='w-[100px]'>
                  ...
                  <InputGroup data-disabled>
                    <InputGroupInput id="block" placeholder={ status === 'active' ? '' : 'None'}  disabled value={query.block ?? ''} />
                    {(status === 'active' && !query.block ) && (
                      <InputGroupAddon>
                        <LoaderIcon className="animate-spin w-4 h-4" />
                      </InputGroupAddon>
                    )}
