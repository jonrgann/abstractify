export interface Document {
  ...
  export const DEED_TYPES = ['DEED','WARRANTY DEED',"SPECIAL WD","TRUSTEES DEED", "TAX DEED", "REDEMPTION DEED","QUITCLAIM DEED", "MASTER DEED", "DEED IN LIEU OF FORECLOSURE", "CORRECTION DEED", "COMMISSIONERS DEED", "BENEFICIARY DEED"]  as const;
